...
def main():
    ...
    metrics = []
    model = pd.read_csv("./Evaluation_Metrics/mmr_reranked_result.csv")
    ...
    average_metrics.to_csv("./Evaluation_Metrics/mmr_reranked_raverage_relevance_result.csv", header=["average"], index_label="metric")
    print(f"Average results saved to ./Evaluation_Metrics/average_results.csv")
main()
